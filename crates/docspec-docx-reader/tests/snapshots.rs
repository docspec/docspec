...
//!
//! Two corpora are exercised, each in its own module:
...
//! streams (a divergence anywhere in either corpus fails fast) and the
...
//!
//! Both corpora flow through the same [`assert_fixture_snapshot`] helper. The
